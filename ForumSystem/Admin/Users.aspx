<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Users.aspx.cs" Inherits="ForumSystem.Admin.Users" %>

<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    <asp:GridView runat="server" ID="GridViewBooks" ItemType="ForumSystem.Models.User" SelectMethod="GridViewBooks_GetData" UpdateMethod="GridViewBooks_UpdateItem" DeleteMethod="GridViewBooks_DeleteItem" AllowSorting="True" AllowPaging="True" PageSize="5" AutoGenerateColumns="true" DataKeyNames="ID">
        <%--        <Columns>
        ...
        <ContentTemplate>
            <asp:FormView runat="server" ID="FormViewIsertBook" DefaultMode="Insert" ItemType="LibrarySystem.Models.Book"
                ...
                <InsertItemTemplate>
                    ...
                    <asp:LinkButton runat="server" ID="LinkButtonCancel" CssClass="link-button" Text="Cancel" CommandName="Cancel" PostBackUrl="~/Admin/Users.aspx" />
                </InsertItemTemplate>
            </asp:FormView>
        </ContentTemplate>
    </asp:UpdatePanel>--%>
